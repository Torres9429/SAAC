...
<body class="body-image">
  ...
  <div class="caja">
    <h1 style="color: #009475; text-shadow: 2px 2px 4px rgba(0, 0, 0, 0.5); margin-top: 10px;">¡Bienvenido Halcón!</h1><br>
    <hr class="separator"><br>
    <!--<h2 style="color: #002E60; margin-top: 10px;"><%=usuario.getNombre()%></h2>-->
  </div>
