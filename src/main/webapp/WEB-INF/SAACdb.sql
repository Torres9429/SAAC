...
CREATE TABLE `asesoria` (
  ...
  KEY `evaluacion_idx` (`id_evaluacion`),
  ...
  CONSTRAINT `evaluacion` FOREIGN KEY (`id_evaluacion`) REFERENCES `evaluacion` (`id_evaluacion`),
...
INSERT INTO `asesoria` VALUES (1,6,2,2,2,4,3,'Cómo utilizar los inner join','08:00:00','09:15:00','2024-07-31',NULL),(2,6,2,3,7,18,4,'Comandos','13:00:00','14:00:00','2024-08-02',NULL),(3,7,12,6,12,4,1,'Cómo hacer la presentación del proyecto','10:00:00','11:00:00','2024-08-17',NULL),(4,6,2,5,10,17,4,'Cómo relacionar tablas','11:00:00','12:00:00','2024-08-09',NULL),(5,20,2,1,11,1,2,'','10:00:00','11:00:00','2024-08-07',NULL),(6,7,2,4,13,19,4,'Sobreescritura de metodos','10:00:00','11:00:00','2024-08-21',NULL),(7,7,2,6,15,3,4,'Presentación del proyecto','11:00:00','12:00:00','2024-08-22',NULL);
...
INSERT INTO `calificacion_asesoria` VALUES (1,'Muy buena'),(2,'Buena'),(3,'Regular'),(4,'Mala');
/*!40000 ALTER TABLE `calificacion_asesoria` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `calificacionesev`
--

DROP TABLE IF EXISTS `calificacionesev`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `calificacionesev` (
  ...
  KEY `asesoria_idx` (`id_asesoria`),
  KEY `usuario_idx` (`id_usuario`),
  KEY `calificacion_idx` (`id_calificacion`),
  CONSTRAINT `asesoria` FOREIGN KEY (`id_asesoria`) REFERENCES `asesoria` (`id_asesoria`),
  CONSTRAINT `calificacion` FOREIGN KEY (`id_calificacion`) REFERENCES `calificacion_asesoria` (`id_calificacion`),
  CONSTRAINT `usuario_ev` FOREIGN KEY (`id_usuario`) REFERENCES `usuario` (`id_usuario`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `calificacionesev`
--

LOCK TABLES `calificacionesev` WRITE;
/*!40000 ALTER TABLE `calificacionesev` DISABLE KEYS */;
INSERT INTO `calificacionesev` VALUES (1,'Tener más puntualidad',3,2,2),(2,'Ser más explicativo al abordar los temas',2,12,3),(3,'Ser más puntual y prestar más atención',2,6,4),(4,'Mayor tolerancia para los estudiantes',3,2,4),(5,'Anticipar sus dudas para agilizar la asesoría',2,7,3),(6,'Ser más puntual.',1,7,6),(7,'ser más puntual',2,7,7);
/*!40000 ALTER TABLE `calificacionesev` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `evaluacion` VALUES (1,'Buscando más puntualidad en el docente',3,2,6,2),(2,'Puntualidad y prestar más atención',2,12,7,3),(3,'Ser más entendible a la hora de dar respuestas o explicar',3,2,6,4),(4,'Ser más entendible a la hora de dar respuestas o explicar',3,2,6,4);
...
INSERT INTO `materia` VALUES (1,'Aplicaciones Web',1),(2,'Base de Datos',1),(3,'Sistemas operativos',1),(4,'Programación orientada a objetos',1),(5,'Bases de Datos para Aplicaciones',1),(6,'Integradora I',1),(7,'Probabilidad y Estadística',3),(9,'Álgebra Lineal',8),(11,'Electricidad y Magnetismo',8);
/*!40000 ALTER TABLE `materia` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `materia_nueva`
--

DROP TABLE IF EXISTS `materia_nueva`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `materia_nueva` (
...
--
-- Dumping data for table `materia_nueva`
--

LOCK TABLES `materia_nueva` WRITE;
/*!40000 ALTER TABLE `materia_nueva` DISABLE KEYS */;
INSERT INTO `materia_nueva` VALUES (1,8,'Álgebra lineal',8,'INSERT','2024-08-18 12:11:33'),(2,9,'Álgebra Lineal',8,'INSERT','2024-08-18 18:45:26'),(3,11,'Electricidad y Magnetismo',8,'INSERT','2024-08-18 18:50:21');
/*!40000 ALTER TABLE `materia_nueva` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2024-08-19 10:01:10
